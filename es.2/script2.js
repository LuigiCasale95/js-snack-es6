 ...
 */
const liSquadre = document.querySelector(".listaSquadre")
const liSquadre2 = document.querySelector(".listaSquadre2")
...
for (i = 0; i<squadre.length; i++) {
    liSquadre.innerHTML += `<li>${squadre[i].nome}-- Punti= ${squadre[i].punti}-- Falli subbiti=${squadre[i].falliSub}</li>`
    liSquadre2.innerHTML += `<li>${squadre[i].nome}-- Falli subbiti=${squadre[i].falliSub}</li>`
}
